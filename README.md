...
Учебная онлайн-платформа, демонстрирующая работу **ORM и Hibernate**.  
Проект реализует систему управления курсами с использованием **Spring Boot**, **JPA/Hibernate** и **PostgreSQL**.

---

## 🚀 Основные возможности

- 👥 **Управление ролями пользователей** — студент, преподаватель, администратор  
- 📚 **Каталог курсов** — создание, редактирование и публикация курсов  
- 🧩 **Структура обучения** — модули, уроки, домашние задания  
- 🧠 **Тестирование** — викторины и система оценки знаний  
- 🔗 **Регистрация студентов** — связи Many-to-Many между пользователями и курсами  
- 🏆 **Система оценок** — результаты, комментарии и фидбек  
...
- ⚙️ **Gradle** (система сборки)

---

## 🧩 Модель данных

Проект содержит более **17 JPA-сущностей**, связанных между собой различными типами связей.
...
| `Enrollment` | Регистрация студентов *(ManyToMany)* |
| `Module` | Раздел курса |
| `Lesson` | Урок |
| `Assignment` | Задание |
| `Submission` | Решение |
...
Все связи используют **ленивую загрузку** (`FetchType.LAZY`).
...
- Java 17+
- Gradle (или встроенный wrapper)

---

### ⚡ Быстрый запуск

#### Вариант 1 — H2 (встроенная БД)
